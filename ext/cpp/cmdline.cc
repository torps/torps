...
const char *gengetopt_args_info_purpose = "Standalone Vivaldi coordinate system";

const char *gengetopt_args_info_usage = "Usage: safest_ext -p <port> ";

const char *gengetopt_args_info_description = "A tool that will run the Vivaldi coordinate system as a standalone entity";

const char *gengetopt_args_info_help[] = {
  "  -h, --help      Print help and exit",
  "  -V, --version   Print version and exit",
  "  -p, --port=INT  The port to listen on",
    0
};
