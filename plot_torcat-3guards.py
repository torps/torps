...
def main():
    ...
    plotcdf([torrates['exitbad'], catrates['exitbad'], torrates3g['exitbad'], catrates3g['exitbad']], ["Tor-1G", "CAT-1G", "Tor-3G", "CAT-3G"], "Fraction of Streams", "Stream Compromise Rates, Exit Only", "lower right", "torcat-exitbad-rates-cdf-typical-2012-10--2013-03.pdf")
